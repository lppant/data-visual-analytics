...
class Data():
    ...
    def dataAllocation(self,path):
        ...
        x_data = records.loc[:, records.columns != "y"]
        y_data = records.loc[:, "y"]
        # -------------------------------
    ...
    def trainSets(self,x_data,y_data):
        ...
        # -------------------------------
        # ADD CODE HERE
        x_train, x_test, y_train, y_test = train_test_split(x_data, y_data, test_size=0.3, train_size=0.7, shuffle=True, random_state=614)
        # -------------------------------
...
# Q3.3.1 Feature Importance
    ...
    def sortedRFFeatureImportanceIndicies(self,rf_clf):
        ...
        # -------------------------------
        # ADD CODE HERE
        sorted_indices = rf_clf.feature_importances_.argsort()[::-1]
        # -------------------------------
...
# Q3.3.2 Hyper-parameter Tuning
    ...
    def hyperParameterTuning(self,rf_clf,x_train,y_train):
        ...
        # -------------------------------
        # ADD CODE HERE
        rf_hyper_parameters = {'n_estimators':[4, 16, 256], 'max_depth':[2, 8, 16]}
        gscv_rfc = GridSearchCV(rf_clf, rf_hyper_parameters, cv=10)
...
# Q3.4.2 Classification
    ...
    def SVCClassifier(self,scaled_x_train,scaled_x_test, y_train):
        ...
        # -------------------------------
        # ADD CODE HERE
        svclassifier=SVC(random_state=100, gamma='auto')
        svclassifier.fit(scaled_x_train, y_train)
        y_predict_train = svclassifier.predict(scaled_x_train)
        y_predict_test = svclassifier.predict(scaled_x_test)
        # -------------------------------
        return y_predict_train,y_predict_test
...
# Q3.4.3 Hyper-parameter Tuning
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        # ADD CODE HERE
        svc = SVC(gamma='auto')
        svm_cv = GridSearchCV(svc, svm_parameters, cv=10, n_jobs=-1, return_train_score=True )
